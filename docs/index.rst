...
El manual es una iniciativa del **`Project on Organizing, Development, Education, and Research (PODER) <https://www.projectpoder.org/>`__**, la **`Iniciativa Latinoamericana por los Datos Abiertos <https://idatosabiertos.org/>`__** y **`Open Contracting Parnershipt (OCP) <https://www.open-contracting.org>`__** escrito por **Ricardo Vega**, **Martín Szyszlican** y **Eduard Martín-Borregón** con la supervisión de Juan Pane y Yohanna Lisnichuk.
